        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <p>사업자번호 000-00-00000 · 대표 홍길동</p>
              <p>대표전화 000-000-0000</p>
              <p>특정 및 제휴 문의 hello@youthfinal.com</p>
          ...
          {/* 회사소개 */}
          <div className="space-y-4">
            <h3 className="font-bold">회사소개</h3>
            <div className="space-y-2">
              <p>
              ...
              <p>
                <a href="/recruit" className="text-gray-300 hover:text-white">
                  채용문의
                </a>
              </p>
            </div>
